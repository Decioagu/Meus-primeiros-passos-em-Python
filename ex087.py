...
matriz = [[], [], []]
cont = somapar = soma3coluna = maio2linha = 0
print()
for linha in range(1,4):
    for coluna in range(1, 4):
        while True:
            num = input(f'Digite um valor para {verde_claro}[{linha}, {coluna}]{limpar}: ').strip()
...
print()
print(f'A soma de todos os valores pares digitados são {verde_claro}{somapar}{limpar}.')
print(f'A soma dos valores da terceira coluna é {verde_claro}{soma3coluna}{limpar}.')
print(f'O maior valor da segunda linha é {verde_claro}{maio2linha}{limpar}.')
